...
if (
    os.getenv("DJANGO_ALLOWED_HOSTS") is not None
    and os.getenv("DJANGO_ALLOWED_HOSTS") != ""
):
...
print(f"base dir is {BASE_DIR} and static root is {STATIC_ROOT}")
...
# if (
#     os.getenv("DJANGO_CORS_ALLOWED_ORIGINS") is not None
#     and os.getenv("DJANGO_CORS_ALLOWED_ORIGINS") != ""
# ):
